...
const PRODUCT_GROUPS: ProductGroup[] = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        workflow: ['在产品页查看内置评测结果示例', '登录后创建数据评测任务并上传授权数据集或工程文件', '填写评测目标与关注问题后提交任务', '在资源中心查看进度、异常样本和整改建议'],
    ...
    products: [
      {
        ...
        workflow: ['在产品页查看可信评测报告示例', '登录后创建可信评测任务并上传模型、工程文件或填写接口信息', '填写评测目标与关注问题后提交', '在资源中心查看分维度评分、问题样本和改进建议'],
