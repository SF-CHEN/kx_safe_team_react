...
const SERIES_DATA: Record<string, {
  ...
  tianyuan: {
    ...
    desc: '覆盖个人信息审查、数据集安全评测、AIGC审核与标识追溯',
    longDesc: '数据侧产品覆盖个人敏感信息审查、数据集安全评测、文本图像音视频内容审核与鉴伪，以及AIGC内容显隐标识、标准检测与审计追溯，为AI数据使用和内容运营提供全流程安全保障。',
    icon: Database,
    grad: 'from-violet-500 to-purple-600',
    glow: 'icon-glow-purple',
    color: '#8b5cf6',
    features: [
      '面向图像分类、目标检测与大模型文本数据的多格式解析',
      '从均衡性、异常样本、标注正确性与完整性开展数据质量评测',
      '对图像和文本数据中的后门候选样本进行训练前初步筛查',
      '个人敏感信息识别与合规审查',
      '文本、图像、音频与视频内容审核与鉴伪',
      'AIGC内容显式与隐式标识、标准检测及审计追溯',
    ],
    roadmap: [
      { q: '数据任务', items: ['图像分类数据评测', '目标检测数据评测', '大模型文本数据评测'] },
      { q: '评测方法', items: ['均衡性与异常样本分析', '标注正确性与完整性检查', '后门候选样本筛查'] },
      { q: '结果管理', items: ['JSONL结果留存', '异常样本定位', '历史任务对比与审计追溯'] },
    ],
  },
  tianheng: {
    name: '模型侧',
