                ...
                <div key={column.label}>
                  ...
                  <ul className="space-y-3">
                    {column.items.map((item) => (
                      <li key={item.name}>
                        <a href={item.path} className="block text-sm leading-relaxed text-blue-300 transition-colors hover:text-white">
                          {item.name}
                        </a>
                      </li>
                    ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {FOOTER_RESOURCES.map((item) => (
                <li key={item.label}>
                  <a href={item.path} className="group flex items-center gap-1.5 text-sm text-blue-300 transition-colors hover:text-white">
