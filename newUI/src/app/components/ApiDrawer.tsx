        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', flex: 1, overflow: 'hidden' }}>
          ...
          <div style={{ overflowY: 'auto', padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={{ paddingTop: 4 }}>
              <a href="/developer" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, color: '#6366f1', textDecoration: 'none', fontWeight: 600 }}>
                查看完整 API 接口文档 →
              </a>
              <div style={{ marginTop: 6, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                {['Python SDK', 'Node.js SDK', 'Java SDK', 'Go SDK'].map(s => (
                  <a key={s} href="/developer" style={{ padding: '3px 10px', background: '#1e293b', border: '1px solid #334155', borderRadius: 6, fontSize: 10, color: '#64748b', textDecoration: 'none', fontFamily: 'monospace' }}>{s}</a>
                ))}
              </div>
            </div>
          </div>
